sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("zjblessons/bindingsEditable/app", ".html");
		...
		return Opa5.extend("zjblessons.bindingsEditable.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["zjblessons/bindingsEditable/localService/mockserver"], function (mockserver) {
